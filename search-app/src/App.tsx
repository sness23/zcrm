    ...
    <div className="app">
        ...
        <div className="header-content">
          <div className="header-left">
            ...
            <div className="header-text">
              <h1>search</h1>
              <div className="header-subtitle">Search across all CRM records</div>
            </div>
          </div>
      ...
      <div className="search-container">
        ...
        <div className="results-container">
          {loading && <div className="loading">Searching vault...</div>}

          {error && <div className="error">Error: {error}</div>}

          {!loading && !error && !hasSearched && (
            <div className="empty">
              Type a search query and press Enter to search across all CRM records
            </div>
          )}
